...
{
    // Silence the cancellation exception during shutdown
}
...
async Task RunPeriodicTaskAsync(CancellationToken token, string outputFolder, int intervalMinutes, ILogger<Program> logger, PowerService powerService)
{
...
/// <returns></returns>
async Task DoWorkAsync(CancellationToken token, string outputFolder, ILogger<Program> logger, PowerService powerService)
{
...
/// <param name="logger"></param>
/// <returns></returns>
async Task<(string Period, double Volume)[]> GetDataAsync(ILogger<Program> logger, PowerService powerService)
{
...
/// <param name="logger"></param>
/// <returns></returns>
async Task ExtractCsvAsync( (string Period, double Volume) [] data, string outputFolder, ILogger<Program> logger) {
...
(string outputFolder, int intervalMinutes) LoadSettings(string[] args)
{
    // 3) defaults
...
bool TryGetFromArgs(string[] args, out string outputFolder, out int intervalMinutes)
{
    outputFolder = null;
    intervalMinutes = 0;
...
bool TryGetFromConfig(out string outputFolder, out int intervalMinutes)
{
    outputFolder = null;
    intervalMinutes = 0;
